...
import com.github.jasonhezz.likesplash.data.AccessToken
...
import com.github.jasonhezz.likesplash.data.Me
import com.github.jasonhezz.likesplash.data.MonthStats
import com.github.jasonhezz.likesplash.data.Photo
import com.github.jasonhezz.likesplash.data.SearchPhotoResult
import com.github.jasonhezz.likesplash.data.TotalStats
 ...
 */
const val CLIENT_ID =
    "c94869b36aa272dd62dfaeefed769d4115fb3189a9d1ec88ed457207747be626"//"ca2305e1f165c879c362d1304230db396667e780f612b1693aa76b75089c655c"
...
interface PhotoService {
    ...
    fun getListCuratedPhotos(
        @Query("page") page: Int = 1, @Query("per_page") perPage: Int = 10,
        @OrderBy @Query("order_by") orderBy: String = LATEST
    ): Single<List<Photo>>
    ...
    fun getAPhotoStatistics(
        @Path("id") id: Int, @Query("resolution") resolution: String = DAYS,
