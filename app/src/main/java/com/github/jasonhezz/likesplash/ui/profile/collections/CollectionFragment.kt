...
import com.github.jasonhezz.likesplash.ui.controller.CollectionController
...
class CollectionFragment : Fragment() {
  ...
  private var controller = CollectionController().apply { setFilterDuplicates(true) }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    viewModel.collection.observe(this, Observer {
      it?.let { controller.collections = it }
    })
  }
