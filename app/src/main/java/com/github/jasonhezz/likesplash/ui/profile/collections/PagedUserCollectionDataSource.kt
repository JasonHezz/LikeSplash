 ...
 */
class PagedUserCollectionDataSource(private val userName: String,
    val api: UserService,
    private val retryExecutor: Executor) : PageKeyedDataSource<Int, Collection>() {
  ...
  override fun loadInitial(params: LoadInitialParams<Int>,
    ...
    api.getUserCollection(userName, 1, params.requestedLoadSize).enqueue(
        object : retrofit2.Callback<List<Collection>> {
          ...
          override fun onResponse(call: Call<List<Collection>>,
