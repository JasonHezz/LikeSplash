...
class PopularPhotoController(val context: Context) : AsyncEpoxyController() {
    ...
    var businessPhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
    var girlPhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
    var naturePhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
    var technologyPhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
    var foodPhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
    var travelPhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
    var happyPhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
    var coolPhoto by EpoxyModelProperty { List<Photo?>(3) { null } }
