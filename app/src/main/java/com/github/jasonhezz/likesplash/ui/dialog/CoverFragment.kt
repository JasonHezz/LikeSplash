 ...
 */
class CoverFragment : DialogFragment(), AddCollectionFragment.Companion.Callbacks, CreateCollectionFragment.Companion.Callbacks {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (savedInstanceState == null) {
      childFragmentManager.beginTransaction().add(R.id.action_panel,
          AddCollectionFragment.newInstance(photo!!, data as ArrayList<Collection>)).commit()
    }
  }
